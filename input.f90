...
module input
    ...
    type :: input_t
        ...
        real(dp) :: max_deviation, volume_damping_factor
        integer :: qce_iterations, newton_iterations
    ...
    contains
        ...
        subroutine check_input()
            ...
            if (pmk_input%components > 2) call pmk_error("only pure substances and " // &
                "binary mixtures are implemented")
